...
option(NES_ENABLE_STATISTICS "Enable internal statistics collection via NES_LOG_STAT (default: ON)" ON)
if (NES_ENABLE_STATISTICS)
    message(STATUS "-- Internal statistics: ENABLED")
    add_compile_definitions(NES_STATISTICS_ENABLED)
else ()
    message(STATUS "-- Internal statistics: DISABLED (NES_LOG_STAT is a no-op, zero runtime cost)")
endif ()

option(NES_COLLECT_STATISTICS "Compile benchmark/systest CSV statistics collection support" OFF)
if (NES_COLLECT_STATISTICS)
    if (NOT NES_ENABLE_STATISTICS)
        message(FATAL_ERROR "NES_COLLECT_STATISTICS requires NES_ENABLE_STATISTICS=ON")
    endif ()
    message(STATUS "-- Statistics CSV collection: ENABLED")
    add_compile_definitions(NES_COLLECT_STATISTICS_ENABLED)
else ()
    message(STATUS "-- Statistics CSV collection: DISABLED")
endif ()
